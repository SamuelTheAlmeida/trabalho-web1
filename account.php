...
<div id="colsContainer">
  ...
  <?php endif; ?>
      ...
      <input value="<?= $nickname ?>" readonly minlength="3" maxlength="20" type="text" placeholder="Nickname" name="nicknameLogin" class="loginInputs"> <br>
      <input minlength="8" maxlength="32" required="required" type="password" type="password" placeholder="Senha atual" name="senhaLogin" class="loginInputs">
  		<input minlength="8" maxlength="32" required="required" type="password" type="password" placeholder="Nova senha" name="novaSenhaLogin" class="loginInputs">
